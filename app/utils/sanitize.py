COLUMN_LENGTHS = {
    "Printer": {"patrimonio": 80, "modelo": 80, "serial": 80, "status": 30, "local_atual": 120, "marca": 80, "tipo": 20, "ip_rede": 45, "mac_address": 17, "tecnico": 120},
    "Activity": {"kind": 30, "numero_recibo": 50, "status_atividade": 30, "from_location": 120, "to_location": 120},
...
def sanitizar(valor, model_class: str = None, field: str = None, max_len: int = None):
    if valor is None:
        return None
