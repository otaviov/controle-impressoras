...
class Printer(Base):
    ...
    pecas_faltantes: Mapped[str] = mapped_column(String, nullable=True)
    ultima_revisao_data: Mapped[datetime] = mapped_column(DateTime, nullable=True)
    tecnico_revisao: Mapped[str] = mapped_column(String, nullable=True)
